...
public class DropDown {
	...
	public static void main(String[] args) {
		 ...
		 driver.findElement(By.xpath("/html/body/div[1]/div[3]/div[1]/div[2]/form/fieldset/ol/li[1]/input")).sendKeys("Ashutosh");
		 
		 Select select = new Select(driver.findElement(By.xpath("//*[@id=\'searchSystemUser_userType\']")));
		 select.selectByVisibleText("Admin");
		 
		 driver.findElement(By.xpath("//*[@id=\'searchSystemUser_employeeName_empName\']")).sendKeys("Ashutosh");
